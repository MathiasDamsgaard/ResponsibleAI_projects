...
parser.add_argument('--warm_epochs', type=int, default=1, help='number of warming epochs (default: %(default)s)')
parser.add_argument('--step_size', type=int, default=150, help='step size of the learning rate scheduler (default: %(default)s)')
parser.add_argument('--test_interval', type=int, default=3, help='epoch interval in which to run the model on the test split (default: %(default)s)')
parser.add_argument('--push_interval', type=int, default=3, help='epoch interval in which to push prototypes (default: %(default)s)')
